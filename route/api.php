...
Route::group('api', function () {
    ...
    Route::group(function () {
        ...
        // 凌琪峻添加
        Route::get('param/group/:key', 'api.file.Param/getParamListByKey')->name('getParamListByKey');
        //上传文件签名
        Route::get('upload/getUploadPolicy', 'v1.Oss/getUploadPolicy')->name('getUploadPolicy');
    ...
    Route::group(function () {
        ...
        Route::get('user/checkuserlogininfo', 'v1.user.User/checkUserLoginInfo')->name('checkUserLoginInfo');
